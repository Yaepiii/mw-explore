...
public:
  ...
  FrontierSearch(costmap_2d::Costmap2D* costmap, double potential_scale,
                 double gain_scale,double information_scale,
  ...
  void configUpdate(double min_frontier_size, double potential_scale,
                    double gain_scale, double information_scale, double information_r);
...
private:
  ...
  double potential_scale_, gain_scale_, information_scale_;
  double min_frontier_size_;
  double information_r_;
  double h_rad = 3.0, h_gain = 2.0;
};
}
#endif
